...
export const ColorScheme = () => {
    ...
    const greyPrimary = ["#FFF", "hsl(220, 35%, 97%)", "hsl(220, 30%, 94%)", "hsl(220, 20%, 88%)", "hsl(220, 20%, 80%)", "hsl(220, 20%, 65%)", "hsl(220, 20%, 42%)", "hsl(220, 20%, 35%)", "hsl(220, 20%, 25%)", "hsl(220, 30%, 6%)", "hsl(220, 35%, 3%)"];
